  ...
  final charWidget = ResetDimension(
    ...
    child: RichText(
      text: TextSpan(
        text: character,
        style: TextStyle(
          fontFamily: KaTeXFontFamilies.packaged('KaTeX_${font.fontFamily}'),
          fontWeight: font.fontWeight.toFlutterFontWeight,
          fontStyle: font.fontShape.toFlutterFontStyle,
