...
import 'package:flutter_math_model/ast.dart' as model
    show MatrixColumnAlign, MatrixRowAlign, MatrixSeparatorStyle;
...
typedef MatrixSeparatorStyle = model.MatrixSeparatorStyle;
typedef MatrixColumnAlign = model.MatrixColumnAlign;
typedef MatrixRowAlign = model.MatrixRowAlign;
